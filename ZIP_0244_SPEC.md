...
This new commitment is named hashAuthDataRoot and is the root of a binary Merkle tree of transaction authorizing data commitments having height 
c
e
i
l
...
2
​
 (tx_count)) , padded with leaves having the "null" hash value [0u8; 32]. Note that 
l
o
g
2
...
2
​
 (tx_count) is well-defined because 
t
x
_
c
...
>
0
tx_count>0 , due to the coinbase transaction in each block. Non-leaf hashes in this tree are BLAKE2b-256 hashes personalized by the string "ZcashAuthDatHash".
...
11	Why does the signature message commit to the scriptPubKey?
...
14	Bitcoin Developer Reference. TxOut: A Transaction Output
